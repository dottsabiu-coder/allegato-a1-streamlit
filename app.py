...
INVENTARIO ATTREZZATURE BIOMEDICHE (da aggiornare con i dati reali)
RU-01 | Riunito odontoiatrico n.1     | Sala 1          | Funzionante
RU-02 | Riunito odontoiatrico n.2     | Sala 2          | Funzionante
RX-01 | Ortopantomografo (OPT)        | Sala RX         | Funzionante
ST-01 | Autoclave Classe B            | Sterilizzazione | Funzionante
SC-01 | Scanner intraorale            | Sala 1          | Funzionante
CP-01 | Compressore odontoiatrico     | Locale tecnico  | Funzionante

VERIFICA ANNUALE
Data ultima verifica: {oggi}    Firma Responsabile Manutenzione: ______________________

COLLAUDO NUOVE ACQUISIZIONI
Ad ogni nuova acquisizione: collaudo tecnico di sicurezza. Verbale conservato nella documentazione tecnica.""",
