...
def *build_inventario(s, nome, tit, dir*, resp_mnt, anno, oggi):
...
1. ANALISI PROCESSI E FASI CRITICHE
...
1. PROCEDURA EMERGENZA MEDICA
1. Valutare lo stato del paziente  2. Chiamare il 118  3. Applicare protocollo BLSD
1. Non lasciare mai solo il paziente  5. Compilare modulo segnalazione evento
...
1. RISCHI CLINICI IDENTIFICATI E MISURE
...
1. PREVENZIONE INFEZIONI CORRELATE ALL’ASSISTENZA
...
1. RACCOLTA E ANALISI EVENTI AVVERSI
...
1. PROCEDURA IN CASO DI PUNTURA O TAGLIO
1. Lasciare sanguinare abbondantemente senza premere
1. Lavare con acqua corrente e sapone per almeno 5 minuti
1. Disinfettare con ipoclorito di sodio al 5% o alcol 70%
1. Segnalare immediatamente al Responsabile
1. Recarsi al Pronto Soccorso entro 1-2 ore
1. Compilare modulo denuncia infortunio
1. PROCEDURA IN CASO DI SCHIZZO SU MUCOSE/OCCHI
...
1. ACCOGLIENZA E ACCESSO ALLE CURE
...
1. RISULTATI PERIODO DI RIFERIMENTO (da compilare)
   Periodo: ***/***/______ - ***/***/______
